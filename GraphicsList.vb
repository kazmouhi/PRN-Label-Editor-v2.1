...
#Region "Path Classes"
            ...
            Private Class BezierSegment
                ...
                ' Or, keep the strongly-typed version and ensure it's complete
                Public Function CloneSegment() As BezierSegment
                    Dim cloner As New BezierSegment()

                    ' PointF is a struct, so direct assignment is a copy.
                    ' New PointF() is also fine and can be clearer.
                    cloner.StartPoint = Me.StartPoint
                    cloner.EndPoint = Me.EndPoint
                    cloner.Control1 = Me.Control1
                    cloner.Control2 = Me.Control2

                    cloner.SegmentType = Me.SegmentType
                    cloner.Keep = Me.Keep
                    cloner.IsInside = Me.IsInside
                    cloner.PathIndex = Me.PathIndex
                    cloner.SegmentIndex = Me.SegmentIndex
                    cloner.T1 = Me.T1
                    cloner.T2 = Me.T2
